...
3. Fill in the project form:
   ...
   - **Project Details**:
     - **Segment** (Subsidy or Non-Subsidy) and **Project service type** (EPC Project, Panel Cleaning, Maintenance, etc.)
     - **System Capacity (kW)** — **whole numbers only** (integer kW)
     - **Order value** and **Confirmation date**
     - **Lead source** — if **Referral**, **Channel Partner**, or **Other**, the matching detail name is **required**
   - **Sales & Commercial**:
...
6. You'll be redirected to the Projects list (or project detail)
...
- **CRM keyboard shortcuts** (when not typing in a field): see [Keyboard shortcuts](#keyboard-shortcuts) in Getting Started.
