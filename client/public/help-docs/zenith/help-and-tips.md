...
- **Search help…** in the Help sidebar searches across all sections; click a result to open that section. Use the section list for **Getting Started**, **Roles**, **Modules**, **Dashboard**, **Zenith**, **Security**, **FAQ**, and **Training**.
