...
- **CRM keyboard shortcuts** (when not typing in a field): **?** opens Help; **Ctrl+Shift+D** Dashboard, **C** Customers, **P** Projects, **K** Support Tickets, **Z** Zenith; **Ctrl+Shift+M** opens **Customers** with **New Customer** (same as **`/customers?new=1`**); **E** **new project** (role limits apply). On Mac use **⌘** instead of **Ctrl**. Full list: [Getting Started → Keyboard shortcuts](/help/getting-started#keyboard-shortcuts) or [Analytics → Keyboard shortcuts](/help/analytics#keyboard-shortcuts).
