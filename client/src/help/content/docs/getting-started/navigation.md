...
| **Ctrl+Shift+M** | **⌘⇧M** | **My Day** — personal **Tasks**, **Journal** & **Reminders** (all roles). Pin from Dashboard **Today's plan**, **Things needing attention**, or Zenith **Hit List** with **+ My Day**; optional remark on project-pinned task complete; **⋯** edit/delete; journal **Load more**; live connection required (not Zenith offline queue) |
