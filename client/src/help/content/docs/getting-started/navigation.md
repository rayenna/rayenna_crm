...
| **Ctrl+Shift+M** | **⌘⇧M** | **My Day** — Tasks (incl. **Suggested from CRM**), Journal & Reminders (all roles). **+ My Day** on Zenith Hit List; optional remark on project-pinned task complete; **⋯** edit/delete; journal **Load more**; live connection required (not Zenith offline queue) |
