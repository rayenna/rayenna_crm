...
Go to **Customers** (Customer Master) and click **New Customer**. Fill in name (or first/last for individuals), address, at least one contact number, and other optional details. Sales and Admin can create customers; Sales see **My Customers** and **All Customers** (view-only for others’ customers).
