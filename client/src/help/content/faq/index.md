...
Press **?** (question mark) when you are not typing in a field, or use **Help (?)** in the **user menu** (top right). Help content is organised by section (Getting Started, Roles, Modules, **Dashboard**, **Zenith**, Training, Security, FAQ). Use **Search help…** in the Help sidebar to find text across sections. Classic dashboard filters, Quick Access, and charts: **[Dashboard](/help/dashboard)**. Full-screen command center: **[Zenith](/help/zenith#zenith-command-center)**. For **Tip of the Day**, **Search help**, **Esc** behaviour, and Support Tickets shortcuts, see [Help and tips](/help/zenith#help-and-tips) on the Zenith help page.

### What is Tip of the Day?
A rotating library of short hints (Dashboard, Zenith, Projects, shortcuts, and more). It may appear once per day after login. Reopen anytime from the user menu → **Tip of the Day**. Use **Next tip** to browse; **Don’t show again** stops automatic tips until you clear site data for this app (this preference is stored in the browser, not synced across devices). Details: [Zenith → Help and tips](/help/zenith#help-and-tips).
...
Navigate to a project and use the Support Tickets section to create a new ticket.
