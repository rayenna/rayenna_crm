...
The briefing may include a **Your My Day** block (above CRM pipeline lines) with a short summary of open tasks and a link to open the ☀ drawer — same cross-device **My Day** data as the nav icon and Zenith **Today’s plan** card.

For **Sales**, **Admin**, and **Operations** — not **Finance** — if any projects in **Under Installation**, **Completed**, or **Completed – Subsidy Credited** are missing **panel and/or inverter brand**, the briefing can add a **reminder line** with a **count** and **customer names**, using the same **Zenith explorer** slice as your command-bar **FY / Quarter / Month**.

**Sales**, **Admin**, and **Management** may also see a **Needs review** briefing line when dates, payments, or capacity do not match stage (same explorer slice). This mirrors [Things needing attention](/help/dashboard#things-needing-attention-dashboard) on Zenith’s Today / KPIs tab.
