...
| **Version note** | Includes **mobile** command bar (dropdown filters, briefing top-right). Hit List: pipeline-style **filters + sort**; quick drawers: **Recent remarks** before **Log activity**. |
