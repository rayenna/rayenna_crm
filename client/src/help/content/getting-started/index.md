...
5. **Zenith**: Open **Zenith ✦** from the Dashboard menu for Rayenna’s full-screen **command center** — same FY / Quarter / Month rules as the dashboard, **AI Insights**, **The Board** sales leaderboard (click totals or rows to open deal lists), **collapsible Your Focus** panels, **Revenue forecast** (stage-weighted pipeline), **clickable charts** with a **Quick Actions** drawer, optional **Victory** toast when a deal hits a winning stage, and animated KPIs. Start at [Analytics → Zenith Command Center](/help/analytics#zenith-command-center); for chart and board lists see [Explore charts & drill-down](/help/analytics#explore-charts-and-drill-down-zenith) and [The Board](/help/analytics#the-board-leaderboard).
