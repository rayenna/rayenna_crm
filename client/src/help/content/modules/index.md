...
- **Things needing attention** — **Sales**, **Operations**, and **Admin**: **Things Needing Attention** card beside **Today's plan** (side by side on laptop) when late-stage projects miss **panel and/or inverter brand**; rows include **+ My Day** and **Projects →** with **Lifecycle specs incomplete**. **Zenith** [daily briefing](/help/zenith#daily-briefing-zenith) can show the same reminder for **Sales**, **Admin**, and **Operations** (not **Management** / **Finance**). Details: [Dashboard → Things needing attention](/help/dashboard#things-needing-attention-dashboard).
