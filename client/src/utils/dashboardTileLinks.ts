/**
 * Build /projects URL with optional status, paymentStatus, availingLoan and dashboard date filters (FY, Quarter, Month).
 * Pure function – safe to call on every render; URLSearchParams is lightweight.
 */
export function buildProjectsUrl(
  params: { status?: string[]; paymentStatus?: string[]; availingLoan?: boolean },
