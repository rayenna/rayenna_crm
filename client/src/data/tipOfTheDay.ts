...
export const TIPS: string[] = [
  ...
  'Zenith Today’s plan sits under the KPI band on the Today / KPIs tab — My Day teasers plus Suggested from CRM with + My Day. On Sales / Admin / Management desktop it sits beside the Hit List; on mobile KPIs stay first. Sales and Admin may also see Things needing attention when late-stage brands are missing; Finance sees the plan only. Full Tasks / Journal / Reminders stay in the nav My Day drawer.',
