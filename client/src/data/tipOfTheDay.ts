...
export const TIPS: string[] = [
  ...
  'Zenith: Today’s Hit List shows up to seven urgent deals with the same filter/sort pattern as Company pipeline today, plus an Alert column — Open → opens Quick Actions. On tablet/desktop widths, a short hint may remind you to scroll the table and use Open →; on small phones that hint is hidden so the layout stays clean.',
