...
export const TIPS: string[] = [
  ...
  'Zenith: Today’s Hit List shows up to seven urgent deals with the same filter/sort pattern as Company pipeline today, plus an Alert column — Open → opens Quick Actions.',
