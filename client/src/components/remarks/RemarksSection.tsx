      ...
      {isEditMode && (
        <div className="mb-6 pb-6 border-b border-gray-200">
          ...
          <button
            ...
            className="bg-primary-600 text-white px-4 py-2 rounded-lg hover:bg-primary-700 font-medium disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
          >
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="bg-primary-600 text-white px-3 py-1.5 rounded text-sm hover:bg-primary-700 font-medium disabled:bg-gray-300 disabled:cursor-not-allowed"
                      >
