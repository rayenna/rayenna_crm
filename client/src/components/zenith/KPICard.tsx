...
export default function KPICard({
  ...
  const inner = (
    ...
    >
      ...
      {to || onClick ? (
        <p className="zenith-kpi-drill-hint mt-1 shrink-0 text-[9px] font-semibold text-[color:var(--accent-teal)] opacity-80 group-hover:opacity-100">
          Opens list →
        </p>
      ) : null}

      <div className="mt-auto zenith-kpi-card__sparkline h-8 w-full pt-2 opacity-[0.88] transition-opacity duration-200 group-hover:opacity-100 sm:h-9">
