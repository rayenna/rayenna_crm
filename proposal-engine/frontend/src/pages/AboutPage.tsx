...
const RAW_LINES: string[] = [
  ...
  '',
  'This Proposal Engine was custom-designed and developed for the operational needs of Rayenna Energy Private Limited.',
  'Initial workflows and data structures were informed by the Company\'s internal cadence, Costing Sheets, BOM and Proposal formats. The software implementation, system architecture, logic, design patterns, and user experience represent original work independently conceived and executed by SHABEER MOHAMED KOZHAKKANIYIL.',
  '',
  ...
  'Ownership & License',
  '',
  'This software is licensed to Rayenna Energy Private Limited solely for its authorized internal business use. Ownership of the software rests completely with SHABEER MOHAMED KOZHAKKANIYIL. Licensing for use by Rayenna Energy Private Limited does not transfer ownership, authorship, inventorship, or any intellectual property rights.',
  'SHABEER MOHAMED KOZHAKKANIYIL holds complete legal and intellectual property rights in this product and retains the exclusive right to sell, resell, distribute, license, sublicense, assign, or enter into any business relationship relating to this software, in whole or in part, without restriction arising from the Company\'s licensed use.',
  '',
  'Restrictions',
  '',
  'No part of this software may be reproduced, modified, reverse engineered, distributed, licensed, transferred, sold, or otherwise commercially exploited in whole or in part, without explicit written authorization from SHABEER MOHAMED KOZHAKKANIYIL, the rightful intellectual property owner.',
  '',
