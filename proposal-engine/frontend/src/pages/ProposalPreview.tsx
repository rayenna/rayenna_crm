      ...
      <div className="print-hide bg-gradient-to-br from-white via-primary-50/40 to-white shadow-2xl rounded-2xl border-2 border-primary-200/50 overflow-hidden backdrop-blur-sm">
        ...
        <div className="px-4 sm:px-6 md:px-8 py-6 sm:py-8">
          {!proposal ? (
            ...
            <div ref={printRef} id="proposal-print-root" className="bg-white rounded-2xl border border-primary-100 shadow-sm overflow-hidden">
              {/* Letterhead */}
              ...
              <div className="px-4 sm:px-8 py-6 sm:py-8">
                ...
                {proposal.bom.length > 0 && (
                  <>
                    ...
                    <div className="print-hide flex items-center justify-end gap-3 -mt-4 mb-6">
                      {commentsSaved && (
                      ...
                      <button
                        ...
                        style={{ background: '#0d1b3a', color: '#fff', borderColor: '#0d1b3a' }}
              ...
              {/* Footer */}
              <div className="print-hide border-t border-primary-100 bg-gradient-to-br from-primary-50/30 to-transparent px-8 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <p className="text-xs text-secondary-400">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                  <div className="flex items-center gap-2">
                    <button
                      onClick={handleExportPdf}
                      disabled={!!exporting}
                      className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 text-xs font-semibold text-white px-4 py-2.5 rounded-xl shadow-lg transition-all disabled:opacity-60 min-h-[44px] sm:min-h-0"
                      style={{ background: '#0d1b3a' }}
                      onMouseEnter={e => (e.currentTarget.style.background = '#0a1530')}
                      onMouseLeave={e => (e.currentTarget.style.background = '#0d1b3a')}
                    >
                  ...
                  <button
                    onClick={handleRegenerate}
                    className="text-xs text-primary-600 hover:text-primary-800 font-medium transition-colors text-center sm:text-left py-1"
                  >
                    ← Edit Details
                  </button>
                </div>
