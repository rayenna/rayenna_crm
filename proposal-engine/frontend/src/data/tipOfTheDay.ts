...
export const TIPS: string[] = [
  ...
  'For AI Roof Layout: Save to Proposal first, then enable Include AI Roof Layout in Proposal — layout and geometry persist per CRM project across devices.',
  'Wrong satellite pin? Paste a full google.com/maps URL in Override location, then Regenerate — not a short goo.gl link.',
  'Roof layout: draw keepouts before Refill panels so vents and tanks are not covered by modules.',
